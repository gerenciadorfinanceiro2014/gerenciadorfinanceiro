...
<!-- fwtable fwsrc="img/novaDespesa/novaDespesa.png" fwpage="Page 1" fwbase="novaDespesa.png" fwstyle="Dreamweaver" fwdocid = "510123378" fwnested="0" -->
  ...
  <form name="novadespesa" action="salvareditardespesa.jsp?idDespesa=<% out.print(request.getParameter("idDespesa")); %>" method="post" >
   <%
     
        DespesaDAO dDAO = new DespesaDAO();
        Despesa despesa = dDAO.Consultar(Integer.parseInt(request.getParameter("idDespesa")));
