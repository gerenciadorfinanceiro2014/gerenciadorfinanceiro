...
<!-- fwtable fwsrc="img/novadespesa/novaDespesa.png" fwpage="Page 1" fwbase="novaDespesa.png" fwstyle="Dreamweaver" fwdocid = "510123378" fwnested="0" -->
  ...
  <tr>
   <td rowspan="26"><img name="novaDespesa_r8_c4" src="img/novadespesa/novaDespesa_r8_c4.png" width="250" height="525" border="0" id="novaDespesa_r8_c4" alt="" /></td>
  ...
  <tr>
   ...
   <select name="categoriareceita" style="width:144px; height:30px;">
